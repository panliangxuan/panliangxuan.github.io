    ...
    ([function (e, t, n) {
                ...
                (0, a.default)(s.default, {
                    ...
                    dynamicLoadSource: function (e, t) {
                        if ((0, s.default)('script[src="' + e + '"]').length)
                            t && t();
                        else {
                ...
                t.CONFIG = {
                    lang: "zh-CN",
                    langMode: null,
                    appId: "jbK7T7bf5sXlBckd46eMBywi-MdYXbMMI",
                    appKey: "t5D8zLoElVicWp0cqEEGNJmk",
                    clazzName: "Comment",
                    meta: ["nick", "mail", "link"],
                    path: location.pathname,
                    placeholder: "输入QQ号将自动拉取昵称、头像和邮箱，填入正确的邮箱将收到邮件回复，留下网址方以便于回访。(其他评论方式可切换至Livere模式登录)",
                    pageSize: 10,
                    recordIP: !0,
                    serverURLs: "",
                    visitor: !1,
                ...
                i.prototype.init = function (e) {
                    ...
                    var t = this;
                    return e && (e = A.default.extend(h.CONFIG, e), t.i18n = (0, f.default)(e.lang || A.default.lang, e.langMode), t.cfg = e, d.default.maps = !!e.emojiMaps && e.emojiMaps || d.default.maps, d.default.cdn = !!e.emojiCDN && e.emojiCDN || d.default.cdn, t._init()),
                    t
                },
                i.prototype._init = function () {
                    ...
                    try {
                        ...
                        var c = B.ds,
                        f = r ? "&q=" + (0, h.RandomStr)() : "";
                        B.params = "?d=" + (c.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + f,
                        B.hide = "hide" === n,
                        B.cdn = /^https?\:\/\//.test(i) ? i : B.cdn,
                        e.cfg.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s,
                        l && (0, b.recordIPFn)(function (e) {
                            return _.ip = e
                        });
                        var p = e.cfg.el || null,
                        d = (0, A.default)(p);
                ...
                $ = {
                    ...
                    show: function (e, t) {
                        ...
                        if (t.forEach(function (e) {
                                ...
                                t && t.text("0"),
                                n.push(/\%/.test((0, A.default)(e).attr("id")) ? decodeURI((0, A.default)(e).attr("id")) : (0, A.default)(e).attr("id"))
                            }), n.length) {
                ...
                i.prototype.bind = function () {
                    ...
                    e.$preview = {
                        show: function () {
                            return O ? (e.$emoji.hide(), i.addClass("actived"), n.html(O).show(), T()) : e.$preview.hide(),
                            e.$preview
                        },
                        hide: function () {
                    ...
                    var f = function (t) {
                        ...
                        r || e.$preview.hide(),
                        O != r && (O = r, i.hasClass("actived") > -1 && O != n.html() && n.html(O), (0, l.default)(t[0]), T())
                    };
                    ...
                    var S = function (t, n, r) {
                        ...
                        o = t.get("ua"),
                        a = "";
                        o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o), a = o.os ? '<span class="vsys">' + o.browser + " " + o.version + '</span> <span class="vsys">' + o.os + " " + o.osVersion + "</span>" : ""),
                    ...
                    T = function () {
                        setTimeout(function () {
                            try {
                                ...
                                "renderMathInElement" in window && renderMathInElement((0, A.default)(".v")[0], {
                                    delimiters: [{
                                            left: "$$",
                                            right: "$$",
                                            display: !0
                    ...
                    P = function (t) {
                        ...
                        if (e.cfg.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(_.mail))
                            return v.mail[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3);
                        if ("" == O)
                    ...
                    M = function () {
                        ...
                        if (_.url = decodeURI(e.cfg.path), _.insertedAt = new Date, j.rid) {
                            ...
                            n.set("rid", j.rid),
                            n.set("pid", r),
                            _.comment = O.replace("<p>", '<p><a class="at" href="#' + r + '">' + j.at + "</a> , ")
                        }
                        for (var i in _)
                        ...
                        n.save().then(function (t) {
                            ...
                            try {
                                j.rid ? S(t, (0, A.default)('.vquote[data-self-id="' + j.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), S(t, e.$el.find(".vcards")), w.skip++),
                    ...
                    z.on("click", P),
                    (0, A.default)(document).on("keydown", function (e) {
                        e = event || e;
                ...
                t.__esModule = !0,
                t.default = function (e, t) {
                    if (e.$el && e.$loading.hide().$nodata.hide(), "[object Error]" === {}
                        .toString.call(t)) {
                ...
                s.prototype = {
                    ...
                    has: function (e) {
                        return {}
                        .hasOwnProperty.call(this.get(), e)
                    },
                    keys: function () {
                        var e = [];
                ...
                function i(e, t) {
                    function n() {
                        "\x3c!--" === e.substr(0, 4) ? d() : p.test(e) ? i(l, g) : f.test(e) && i(s, v),
                        h()
                    }
                    function i(t, n) {
                        var r = e.match(t);
                    ...
                    function h() {
                        if (m) {
                            var n,
                            r = e.indexOf("<");
                            r >= 0 ? (n = e.substring(0, r), e = e.substring(r)) : (n = e, e = ""),
                            t.chars && t.chars(n)
                        }
                    }
                    function v(e, n, r, i) {
                ...
                function r(e, t) {
                    ...
                    function r(e, t, r) {
                        function u(e) {
                            ...
                            d = o(e);
                            "class" === d && -1 === p.indexOf(d) ? (c = c.split(" ").filter(r).join(" ").trim(), u = c.length) : u = -1 !== p.indexOf(d) && (!0 !== a.uris[d] || l(c)),
                            u && (n(" "), n(e), "string" == typeof c && (n('="'), n(i.encode(c)), n('"')))
                        }
                        var s = o(e);
                ...
                (0, function (e) {
                    ...
                    M = function () {
                        ...
                        n.list = function (e) {
                            ...
                            if (t) {
                                ...
                                for (var y = new RegExp("^( {0,3}" + v + ")((?: [^\\n]*)?(?:\\n|$))"); e && (h = !1, t = y.exec(e)) && !this.rules.block.hr.test(e); ) {
                                    ...
                                    m.loose || (l ? m.loose = !0 : /\n *\n *$/.test(n) && (l = !0)),
                                    this.options.gfm && (r = /^\[[ xX]\] /.exec(d)) && (i = "[ ] " !== r[0], d = d.replace(/^\[[ xX]\] +/, "")),
                                    m.items.push({
                                        type: "list_item",
                                        raw: n,
                                        task: !!r,
                        ...
                        n.html = function (e) {
                            ...
                            if (t) {
                                ...
                                return this.options.sanitize && (n.type = "paragraph", n.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : s(t[0]), n.tokens = [], this.lexer.inline(n.text, n.tokens)),
                                n
                            }
                        },
                        n.def = function (e) {
                        ...
                        n.url = function (e, t) {
                            ...
                            if (n = this.rules.inline.url.exec(e)) {
                                ...
                                i;
                                if ("@" === n[2])
                                    r = s(this.options.mangle ? t(n[0]) : n[0]), i = "mailto:" + r;
                                else {
                                    var o;
                                    do {
                                        o = n[0],
                    ...
                    var U = function () {
                        function t(t) {
                            ...
                            this.options.pedantic ? (n.block = L.pedantic, n.inline = N.pedantic) : this.options.gfm && (n.block = L.gfm, this.options.breaks ? n.inline = N.breaks : n.inline = N.gfm),
                            ...
                            for (var r, i, o, a; e; )
                                if (!(this.options.extensions && this.options.extensions.block && this.options.extensions.block.some(function (i) {
                                    ...
                                    if (r = this.tokenizer.space(e))
                                        ...
                                        e = e.substring(r.raw.length), i = t[t.length - 1], !i || "paragraph" !== i.type && "text" !== i.type ? t.push(r) : (i.raw += "\n" + r.raw, i.text += "\n" + r.text, this.inlineQueue[this.inlineQueue.length - 1].src = i.text);
                                        ...
                                        e = e.substring(r.raw.length), i = t[t.length - 1], !i || "paragraph" !== i.type && "text" !== i.type ? this.tokens.links[r.tag] || (this.tokens.links[r.tag] = {
                                                href: r.href,
                                                title: r.title
                            ...
                            for (; e; )
                                if (u || (s = ""), u = !1, !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some(function (i) {
                                    ...
                                    if (r = this.tokenizer.escape(e))
                                        ...
                                        e = e.substring(r.raw.length), i = t[t.length - 1], i && "text" === r.type && "text" === i.type ? (i.raw += r.raw, i.text += r.text) : t.push(r);
                                        ...
                                        if (o = e, this.options.extensions && this.options.extensions.startInline && function () {
                                            ...
                                            e = e.substring(r.raw.length), "_" !== r.raw.slice(-1) && (s = r.raw.slice(-1)), u = !0, i = t[t.length - 1], i && "text" === i.type ? (i.raw += r.raw, i.text += r.text) : t.push(r);
                                        else if (e) {
                    ...
                    W = function () {
                        ...
                        t.getNextSafeSlug = function (e, t) {
                            ...
                            return t || (this.seen[e] = r, this.seen[n] = 0),
                            n
                        },
                        t.slug = function (e, t) {
                            void 0 === t && (t = {});
                                ...
                                if (p = e[n], !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type]) || !1 === (x = this.options.extensions.renderers[p.type].call({
                                    ...
                                    case "list":
                                        for (d = p.ordered, h = p.start, v = p.loose, o = p.items.length, f = "", r = 0; r < o; r++)
                                            m = p.items[r], y = m.checked, b = m.task, g = "", m.task && (D = this.renderer.checkbox(y), v ? m.tokens.length > 0 && "paragraph" === m.tokens[0].type ? (m.tokens[0].text = D + " " + m.tokens[0].text, m.tokens[0].tokens && m.tokens[0].tokens.length > 0 && "text" === m.tokens[0].tokens[0].type && (m.tokens[0].tokens[0].text = D + " " + m.tokens[0].tokens[0].text)) : m.tokens.unshift({
                                                    type: "text",
                                                    text: D
                ...
                x = function () {
                    ...
                    return function (t, n) {
                        var r = e[n];
                        return r && !t.pluralTypes[r] && (r = null, e[n] = r),
                        r || (r = i(t, n)) && (e[n] = r),
                        r
                    }
                }
                ...
                e.exports = function e(t, n, F, T) {
                    function I(t, n, r) {
                        if (n && (T = oe.call(T), T.push(n)), r) {
                            ...
                            return v(R, "quoteStyle") && (i.quoteStyle = R.quoteStyle),
                            e(t, i, F + 1, T)
                        }
                        return e(t, R, F + 1, T)
                    }
                    ...
                    if (v(R, "maxStringLength") && ("number" == typeof R.maxStringLength ? R.maxStringLength < 0 && R.maxStringLength !== 1 / 0 : null !== R.maxStringLength))
                        throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
                    var M = !v(R, "customInspect") || R.customInspect;
                    if ("boolean" != typeof M && "symbol" !== M)
                        throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
                    if (v(R, "indent") && null !== R.indent && "\t" !== R.indent && !(parseInt(R.indent, 10) === R.indent && R.indent > 0))
